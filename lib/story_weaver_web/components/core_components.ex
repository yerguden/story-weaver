defmodule StoryWeaverWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoryWeaverWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoryWeaverWeb.Gettext, "errors", msg, opts)
    end
  end
